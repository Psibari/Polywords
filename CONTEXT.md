...
- Patch 17 recommended next: device sanity polish for gameplay arena. Review active tile stack on phone and make visual-only adjustments if needed for stack readability, swipe room, right shatter lane, up absorb, Master Gate spacing, and HUD weight.
