...
// C is reachable by an average run, S aligns with Beat Polly (15000), and
// MASTER sits just under the 5th percentile of perfect play (19700) so a
// flawless hunt reliably earns the title.
export const RANK_TIERS: RankTier[] = [
  ...
  { letter: 'S',      label: 'S',      threshold: 15000, nextAt: 19500, color: '#F5C842',                description: 'Better than Polly.'      },
