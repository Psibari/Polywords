...
export const SESSION: SessionStep[] = [
  ...
  // WORD 2 — SPRING
  {
    ...
    eventType: 'normal',
    meanings: [],
    hiddenMeaning:   'Trigger it fast',
    hiddenTrap:      'Morning freshness',
    hiddenEmoji:     '💥',
    hiddenTrapEmoji: '🌿',
    masks: [
  ...
  // WORD 5 — WAKE
  {
    ...
    eventType: 'normal',
    meanings: [],
    hiddenMeaning:   'Watch over the dead',
  ...
  // WORD 9 — WAVE
  {
    ...
    eventType: 'normal',
    meanings: [],
    hiddenMeaning:   'Sudden surge of it',
    hiddenTrap:      "Surfer's playground",
    hiddenEmoji:     '📈',
    hiddenTrapEmoji: '🏄',
    masks: [
  ...
  // WORD 10 — ROCK
  {
    ...
    eventType: 'slangDrop',
    meanings: [],
    hiddenMeaning:   'Shake the room',
    hiddenTrap:      'Hard and heavy',
    hiddenEmoji:     '💥',
    hiddenTrapEmoji: '🔴',
    masks: [
  ...
  // WORD 11 — WELL
  {
    ...
    eventType: 'wordLore',
    meanings: [],
    hiddenMeaning:   'Rise to the surface',
    hiddenTrap:      'Medical recovery',
    hiddenEmoji:     '🌊',
    hiddenTrapEmoji: '🏥',
    masks: [
  ...
  // WORD 12 — FINE
  {
    ...
    meanings: [],
    hiddenMeaning:   'Clear weather, finally',
    hiddenTrap:      'Law enforcement',
    hiddenEmoji:     '☀️',
    hiddenTrapEmoji: '👮',
    masks: [
  ...
  // WORD 14 — CAN
  {
    ...
    eventType: 'speedRound',
    meanings: [],
    hiddenMeaning:   'Fire someone out',
    hiddenTrap:      'Tin of beer',
    hiddenEmoji:     '🚪',
    hiddenTrapEmoji: '🍺',
    masks: [
  ...
  // WORD 15 — ORDER
  {
    ...
    meanings: [],
    hiddenMeaning:   'A holy brotherhood',
    hiddenTrap:      "Court's ruling",
    hiddenEmoji:     '⛪',
    hiddenTrapEmoji: '🏛️',
    masks: [
