...
export const SESSION: SessionStep[] = [
  ...
  },
  {
    ...
    meanings: [],
    masks: [
      { id: 'bolt_fastener', emoji: '🔩', phrase: "Nut's partner", isReal: true },
      { id: 'bolt_dash',     emoji: '💨', phrase: 'Gone in a flash', isReal: true },
      ...
      { id: 'bolt_explode',  emoji: '🌪️', phrase: 'Sudden explosion',         isReal: false, trapType: 'almostSynonym' },
  ...
  },
  {
    ...
    masks: [
      ...
      { id: 'light_sun',    emoji: '🌟', phrase: 'The sun itself',         isReal: false, trapType: 'visualNeighbor' },
      { id: 'light_flash',  emoji: '⚡', phrase: 'Electric flash',         isReal: false, trapType: 'domainNeighbor' },
      { id: 'light_candle', emoji: '🪔', phrase: 'A candle',               isReal: false, trapType: 'visualNeighbor' },
    ],
  },
  {
    kind: 'word',
    ...
    masks: [
      ...
      { id: 'draft_cold',     emoji: '🌬️', phrase: 'Gap in the door',            isReal: true },
      { id: 'draft_recruit',  emoji: '📋', phrase: 'Draft day pick',             isReal: true },
      { id: 'draft_beer',     emoji: '🍺', phrase: 'Pulled from tap',            isReal: true },
