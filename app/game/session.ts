...
export const SESSION: SessionStep[] = [
  ...
  // WORD 1 — BARK
  {
    ...
    eventType: 'normal',
    meanings: [],
    hiddenMeaning:   "Boat's hull covering",
    hiddenTrap:      'Loud crowd noise',
    hiddenEmoji:     '⛵',
    hiddenTrapEmoji: '📣',
    masks: [
  ...
  // WORD 2 — SPRING
  {
    ...
    eventType: 'normal',
    meanings: [],
    hiddenMeaning:   'Coiled metal under pressure',
    hiddenTrap:      'Morning dew',
    hiddenEmoji:     '🌀',
    hiddenTrapEmoji: '💧',
    masks: [
  ...
  // WORD 3 — LIGHT
  {
    ...
    meanings: [],
    hiddenMeaning:   'Start something burning',
    hiddenTrap:      'Easy to understand',
    hiddenEmoji:     '🕯️',
    hiddenTrapEmoji: '💡',
    masks: [
  ...
  // WORD 4 — BANK
  {
    ...
    meanings: [],
    hiddenMeaning:   'Store for later use',
    hiddenTrap:      'Financial interest',
    hiddenEmoji:     '🏦',
    hiddenTrapEmoji: '💰',
    masks: [
  ...
  // WORD 5 — WAKE
  {
    ...
    eventType: 'normal',
    meanings: [],
    hiddenMeaning:   'Gathering after a death',
    hiddenTrap:      'Early morning feeling',
    hiddenEmoji:     '🕯️',
    hiddenTrapEmoji: '😴',
    masks: [
  ...
  // WORD 6 — MATCH
  {
    ...
    eventType: 'decoyTension',
    meanings: [],
    hiddenMeaning:   'Thin wooden fire stick',
    hiddenTrap:      'Mirror image',
    hiddenEmoji:     '🪵',
    hiddenTrapEmoji: '🪞',
    masks: [
  ...
  // WORD 7 — SOUND
  {
    ...
    meanings: [],
    hiddenMeaning:   'Strait between two lands',
    hiddenTrap:      'Audio recording',
    hiddenEmoji:     '🗺️',
    hiddenTrapEmoji: '🎙️',
    masks: [
  ...
  // WORD 9 — WAVE
  {
    ...
    eventType: 'normal',
    meanings: [],
    hiddenMeaning:   'Energy moving through space',
    hiddenTrap:      'Ripple in a pond',
    hiddenEmoji:     '📡',
    hiddenTrapEmoji: '💦',
    masks: [
  ...
  // WORD 10 — ROCK
  {
    ...
    eventType: 'slangDrop',
    meanings: [],
    hiddenMeaning:   'Sway a baby to sleep',
    hiddenTrap:      'Heavy music beat',
    hiddenEmoji:     '👶',
    hiddenTrapEmoji: '🥁',
    masks: [
  ...
  // WORD 11 — WELL
  {
    ...
    eventType: 'wordLore',
    meanings: [],
    hiddenMeaning:   'To a considerable degree',
    hiddenTrap:      'Healthy feeling',
    hiddenEmoji:     '📏',
    hiddenTrapEmoji: '💊',
    masks: [
  ...
  // WORD 12 — FINE
  {
    ...
    meanings: [],
    hiddenMeaning:   'Pure and refined quality',
    hiddenTrap:      'No complaints',
    hiddenEmoji:     '✨',
    hiddenTrapEmoji: '🤷',
    masks: [
  ...
  // WORD 13 — SICK
  {
    ...
    meanings: [],
    hiddenMeaning:   'Deeply disturbing',
    hiddenTrap:      'Needs medicine',
    hiddenEmoji:     '😨',
    hiddenTrapEmoji: '💊',
    masks: [
  ...
  // WORD 14 — CAN
  {
    ...
    eventType: 'speedRound',
    meanings: [],
    hiddenMeaning:   'Fire or dismiss someone',
    hiddenTrap:      'Metal storage tin',
    hiddenEmoji:     '🚪',
    hiddenTrapEmoji: '🥫',
    masks: [
  ...
  // WORD 15 — ORDER
  {
    ...
    meanings: [],
    hiddenMeaning:   'Religious community',
    hiddenTrap:      'Restaurant request',
    hiddenEmoji:     '⛪',
    hiddenTrapEmoji: '🍽️',
    masks: [
