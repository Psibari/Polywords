...
export const libraryMaterial = {
  ...
  woodDark: '#4A3E30',
  woodShadow: '#332A20',
  bookcaseBorder: 'rgba(245,200,66,0.22)',
  bookcaseShade: 'rgba(6,4,22,0.16)',
  bookcaseShadow: PW.shadow.panel,
  ...
  spineLeatherShadow: 'rgba(8,6,24,0.44)',
  spineLeatherHighlight: 'rgba(245,200,66,0.16)',
  spinePanel: 'rgba(10,8,30,0.24)',
  spineGrain: 'rgba(245,200,66,0.10)',
  spineWear: 'rgba(255,247,214,0.16)',
