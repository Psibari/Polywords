...
export const PW = {
  color: {
    ...
    lavender: '#B98ADE',
    rose: '#9B2D6B',
    overlayHeavy: 'rgba(15,13,42,0.88)',
    overlayMedium: 'rgba(15,13,42,0.80)',
    overlayLight: 'rgba(15,13,42,0.36)',
    outlineSoft: 'rgba(255,247,214,0.20)',
    borderMuted: 'rgba(255,255,255,0.06)',
    transparentWhite: 'rgba(255,255,255,0.62)',
    textShadowStrong: 'rgba(0,0,0,0.72)',
    textShadowMedium: 'rgba(0,0,0,0.62)',
    correct: '#4CAF50',
    wrong: '#CC2200',
    shadow: '#000000',
  },
  ...
  motion: {
    ...
    heroBook: {
      ...
      exitMs: 280,         // closed → open (reverse swing on exit)
      fadeInMs: 110,
    },
  },
  z: {
