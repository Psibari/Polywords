  ...
  return (
    <View style={{ width: w, height: h }}>
      <Svg width={w} height={h} viewBox="0 0 26 30">
        <Defs>
          <LinearGradient id="homeSpineLeather" x1="0" y1="0" x2="0" y2="1">
            <Stop offset="0" stopColor={libraryMaterial.spineLeatherTop} />
            <Stop offset="1" stopColor={libraryMaterial.spineLeatherBot} />
          </LinearGradient>
        </Defs>
        <Rect x={1} y={6} width={6} height={22} rx={1.5} fill="url(#homeSpineLeather)" stroke={libraryMaterial.spineToolingHairline} strokeWidth={0.6} />
        <Rect x={2} y={12} width={4} height={1.2} fill={libraryMaterial.spineTooling} />
        <Rect x={9} y={1} width={7} height={27} rx={1.5} fill="url(#homeSpineLeather)" stroke={libraryMaterial.spineToolingHairline} strokeWidth={0.6} />
        <Rect x={10.5} y={8} width={4} height={1.2} fill={libraryMaterial.spineTooling} />
        <Rect x={18} y={8} width={6} height={20} rx={1.5} fill="url(#homeSpineLeather)" stroke={libraryMaterial.spineToolingHairline} strokeWidth={0.6} />
        <Rect x={19.5} y={14} width={4} height={1.2} fill={libraryMaterial.spineTooling} />
      </Svg>
    </View>
  );
}
