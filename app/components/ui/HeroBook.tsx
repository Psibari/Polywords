  ...
  return (
    <View style={styles.book}>
      ...
      >
        ...
        {/* Purple cover thickness — the bound block the pages sit inside, with a
            rounded, slightly flared base so the book bottoms out as a solid volume
            rather than a flat banner edge. This is the primary de-banner cue. */}
        <Path
        ...
        {/* Page block — inset within the purple cover and flared wider toward the
            base, so the cover reads as wrapping a stack of pages. */}
        <Path
      ...
      >
        ...
        >
          <Defs>
            ...
            {/* Spine shares the cover's purple family — a recessed bound band,
                not a separate black bar. */}
          ...
          {/* Top gold tooling — frames the bound spine to match the cover trim */}
